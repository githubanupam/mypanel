...
class User extends MY_Controller
{
    ...
    {
        $this->global['pageTitle'] = 'Sanjog : Users';
        
        $this->loadViews("user/users", $this->global, NULL , NULL);
    }
    ...
    function user_listing()
    {
        ...
        $pageId     = $this->user_model->getPageId($pageName)['pageId'];
        // echo $pageId;
        // echo $roleId;
        $actionAccess = $this->user_model->getActionAccessByPageAndRole($roleId,$pageId);
        // echo "<pre>";
        // print_r($actionAccess);
        // die();
		//echo $this->isAdmin();
		//($this->isAdmin() == false) || (
		//echo 'tick'.$this->isTicketter();
		//die('okk');
        ...
        {   
            ...
            foreach ($fetch_data as $row) {
                ...
                $sub_array[] = getAdminRole($row->roleId);

                $sub_array[]='<div class="form-group status_group">
                                <select class="form-control form-control-sm" id="change_status" onchange="changeStatus('.$row->admin_id.')">
                ...
                foreach ($actionAccess as $row_access) {
                    ...
                    $action_access .= '<a href="'.base_url().'user/'.$row_access['actionName'].'/'.$row->admin_id.'"><i class="fa '.$row_access['actionIcon'].' btn btn-primary btn-xs"></i></a>&nbsp;';
                }
